...
|-------|-----|--------|------|---|---|
|exp|y = 2.3560 exp(-0.0822x)  [TAFE=0.0615]|0.0615|0.0029|11|n/a|
|pow|y = 2.8588 x pow(-0.4502)  [TAFE=0.0390]|0.0390|0.0014|11|n/a|

![Plot](COVID-19_emilia-romagna_j14_2020-04-15.png)
...
[Download data as CSV](COVID-19_emilia-romagna_j14_2020-04-15.csv)
