...
|-------|-----|--------|------|---|---|
|exp|y = 1.4223 exp(-0.0763x)  [TAFE=0.0764]|0.0764|0.0035|5|n/a|
|pow|y = 1.6486 x pow(-0.3930)  [TAFE=0.0575]|0.0575|0.0025|4|n/a|

![Plot](COVID-19_lombardia_j13_2020-04-18.png)
...
[Download data as CSV](COVID-19_lombardia_j13_2020-04-18.csv)
