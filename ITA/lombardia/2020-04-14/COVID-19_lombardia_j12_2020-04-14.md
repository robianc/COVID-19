...
|-------|-----|--------|------|---|---|
|exp|y = 1.8194 exp(-0.0932x)  [TAFE=0.0354]|0.0354|0.0008|7|n/a|

![Plot](COVID-19_lombardia_j12_2020-04-14.png)
...
[Download data as CSV](COVID-19_lombardia_j12_2020-04-14.csv)
