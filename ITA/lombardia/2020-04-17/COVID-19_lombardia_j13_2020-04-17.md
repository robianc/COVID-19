...
|-------|-----|--------|------|---|---|
|exp|y = 1.6227 exp(-0.0849x)  [TAFE=0.0619]|0.0619|0.0026|6|n/a|

![Plot](COVID-19_lombardia_j13_2020-04-17.png)
...
[Download data as CSV](COVID-19_lombardia_j13_2020-04-17.csv)
