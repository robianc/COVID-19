...
|-------|-----|--------|------|---|---|
|exp|y = 1.8266 exp(-0.0909x)  [TAFE=0.0447]|0.0447|0.0014|7|n/a|

![Plot](COVID-19_lombardia_j13_2020-04-16.png)
...
[Download data as CSV](COVID-19_lombardia_j13_2020-04-16.csv)
