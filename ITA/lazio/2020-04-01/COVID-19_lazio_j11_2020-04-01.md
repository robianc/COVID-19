...
|-------|-----|--------|------|---|---|
|linear|y = 7.8360 -0.4843x  [TAFE=0.0723]|0.0723|0.0058|15|17|
|exp|y = 8.6885 exp(-0.1037x)  [TAFE=0.0720]|0.0720|0.0036|21|n/a|

![Plot](COVID-19_lazio_j11_2020-04-01.png)
...
[Download data as CSV](COVID-19_lazio_j11_2020-04-01.csv)
