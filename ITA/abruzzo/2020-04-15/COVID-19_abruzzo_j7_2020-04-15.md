...
|-------|-----|--------|------|---|---|
|pow|y = 0.7062 x pow(0.1406)  [TAFE=0.1472]|0.1472|0.0117|2|n/a|

![Plot](COVID-19_abruzzo_j7_2020-04-15.png)
...
[Download data as CSV](COVID-19_abruzzo_j7_2020-04-15.csv)
