...
|-------|-----|--------|------|---|---|
|exp|y = 3.1032 exp(-0.1250x)  [TAFE=0.0469]|0.0469|0.0021|10|n/a|
|pow|y = 3.4989 x pow(-0.5468)  [TAFE=0.0910]|0.0910|0.0049|10|n/a|

![Plot](COVID-19_abruzzo_j11_2020-04-13.png)
...
[Download data as CSV](COVID-19_abruzzo_j11_2020-04-13.csv)
