...
|-------|-----|--------|------|---|---|
|pow|y = 5.9906 x pow(-0.6472)  [TAFE=0.0543]|0.0543|0.0020|16|n/a|

![Plot](COVID-19_abruzzo_j8_2020-04-03.png)
...
[Download data as CSV](COVID-19_abruzzo_j8_2020-04-03.csv)
