...
|-------|-----|--------|------|---|---|
|linear|y = 2.7031 -0.1328x  [TAFE=0.0733]|0.0733|0.0015|13|21|
|exp|y = 2.9216 exp(-0.0785x)  [TAFE=0.0485]|0.0485|0.0021|14|n/a|

![Plot](COVID-19_friuli_venezia_giulia_j14_2020-04-15.png)
...
[Download data as CSV](COVID-19_friuli_venezia_giulia_j14_2020-04-15.csv)
