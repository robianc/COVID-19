...
|-------|-----|--------|------|---|---|
|linear|y = 2.5326 -0.1256x  [TAFE=0.0855]|0.0855|0.0016|13|21|
|exp|y = 2.7197 exp(-0.0786x)  [TAFE=0.0491]|0.0491|0.0015|13|n/a|

![Plot](COVID-19_friuli_venezia_giulia_j14_2020-04-16.png)
...
[Download data as CSV](COVID-19_friuli_venezia_giulia_j14_2020-04-16.csv)
