...
|-------|-----|--------|------|---|---|
|pow|y = 4.3305 x pow(-0.5244)  [TAFE=0.0453]|0.0453|0.0019|17|n/a|

![Plot](COVID-19_toscana_j13_2020-04-14.png)
...
[Download data as CSV](COVID-19_toscana_j13_2020-04-14.csv)
