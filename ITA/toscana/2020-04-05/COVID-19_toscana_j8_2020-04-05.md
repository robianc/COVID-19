...
|-------|-----|--------|------|---|---|
|exp|y = 2.0667 exp(-0.1235x)  [TAFE=0.0845]|0.0845|0.0049|6|n/a|
|pow|y = 2.1582 x pow(-0.4520)  [TAFE=0.0288]|0.0288|0.0006|6|n/a|

![Plot](COVID-19_toscana_j8_2020-04-05.png)
...
[Download data as CSV](COVID-19_toscana_j8_2020-04-05.csv)
