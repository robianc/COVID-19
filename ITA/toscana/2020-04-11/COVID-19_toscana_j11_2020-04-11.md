...
|-------|-----|--------|------|---|---|
|exp|y = 2.2080 exp(-0.0779x)  [TAFE=0.1039]|0.1039|0.0069|11|n/a|
|pow|y = 2.5214 x pow(-0.3771)  [TAFE=0.0469]|0.0469|0.0017|12|n/a|

![Plot](COVID-19_toscana_j11_2020-04-11.png)
...
[Download data as CSV](COVID-19_toscana_j11_2020-04-11.csv)
