...
|-------|-----|--------|------|---|---|
|linear|y = 4.3921 -0.2718x  [TAFE=0.0688]|0.0688|0.0057|13|17|
|exp|y = 4.8837 exp(-0.1043x)  [TAFE=0.0684]|0.0684|0.0045|16|n/a|

![Plot](COVID-19_puglia_j11_2020-04-12.png)
...
[Download data as CSV](COVID-19_puglia_j11_2020-04-12.csv)
