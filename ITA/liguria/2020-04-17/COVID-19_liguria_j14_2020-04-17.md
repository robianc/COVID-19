...
|-------|-----|--------|------|---|---|
|exp|y = 2.5251 exp(-0.0863x)  [TAFE=0.0595]|0.0595|0.0030|11|n/a|
|pow|y = 3.0680 x pow(-0.4679)  [TAFE=0.0559]|0.0559|0.0026|11|n/a|

![Plot](COVID-19_liguria_j14_2020-04-17.png)
...
[Download data as CSV](COVID-19_liguria_j14_2020-04-17.csv)
