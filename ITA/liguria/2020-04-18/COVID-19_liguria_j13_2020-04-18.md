...
|-------|-----|--------|------|---|---|
|exp|y = 1.5349 exp(-0.0505x)  [TAFE=0.0807]|0.0807|0.0045|9|n/a|
|pow|y = 1.7317 x pow(-0.2734)  [TAFE=0.0536]|0.0536|0.0021|8|n/a|

![Plot](COVID-19_liguria_j13_2020-04-18.png)
...
[Download data as CSV](COVID-19_liguria_j13_2020-04-18.csv)
