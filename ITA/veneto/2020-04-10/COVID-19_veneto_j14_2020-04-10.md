...
|-------|-----|--------|------|---|---|
|linear|y = 6.1248 -0.3287x  [TAFE=0.0332]|0.0332|-0.0009|16|19|
|exp|y = 7.0035 exp(-0.0963x)  [TAFE=0.0505]|0.0505|0.0014|21|n/a|

![Plot](COVID-19_veneto_j14_2020-04-10.png)
...
[Download data as CSV](COVID-19_veneto_j14_2020-04-10.csv)
