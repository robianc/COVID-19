...
|-------|-----|--------|------|---|---|
|exp|y = 4.5726 exp(-0.1061x)  [TAFE=0.0350]|0.0350|0.0010|15|n/a|

![Plot](COVID-19_veneto_j14_2020-04-15.png)
...
[Download data as CSV](COVID-19_veneto_j14_2020-04-15.csv)
