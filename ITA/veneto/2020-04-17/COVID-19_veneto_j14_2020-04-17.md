...
|-------|-----|--------|------|---|---|
|exp|y = 3.5744 exp(-0.0979x)  [TAFE=0.0558]|0.0558|0.0023|14|n/a|

![Plot](COVID-19_veneto_j14_2020-04-17.png)
...
[Download data as CSV](COVID-19_veneto_j14_2020-04-17.csv)
