...
|-------|-----|--------|------|---|---|
|exp|y = 2.6374 exp(-0.0874x)  [TAFE=0.0550]|0.0550|0.0025|12|n/a|
|pow|y = 3.0761 x pow(-0.4415)  [TAFE=0.0694]|0.0694|0.0030|13|n/a|

![Plot](COVID-19_veneto_j13_2020-04-17.png)
...
[Download data as CSV](COVID-19_veneto_j13_2020-04-17.csv)
