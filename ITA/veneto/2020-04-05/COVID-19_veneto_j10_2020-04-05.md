...
|-------|-----|--------|------|---|---|
|linear|y = 3.7173 -0.2088x  [TAFE=0.0423]|0.0423|0.0026|14|18|
|exp|y = 3.9634 exp(-0.0843x)  [TAFE=0.0531]|0.0531|0.0018|17|n/a|

![Plot](COVID-19_veneto_j10_2020-04-05.png)
...
[Download data as CSV](COVID-19_veneto_j10_2020-04-05.csv)
