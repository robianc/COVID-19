...
|-------|-----|--------|------|---|---|
|exp|y = 5.6833 exp(-0.1065x)  [TAFE=0.0273]|0.0273|0.0007|17|n/a|

![Plot](COVID-19_veneto_j14_2020-04-13.png)
...
[Download data as CSV](COVID-19_veneto_j14_2020-04-13.csv)
