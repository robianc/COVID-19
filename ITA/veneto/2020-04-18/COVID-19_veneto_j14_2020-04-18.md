...
|-------|-----|--------|------|---|---|
|exp|y = 3.0939 exp(-0.0907x)  [TAFE=0.0625]|0.0625|0.0026|13|n/a|

![Plot](COVID-19_veneto_j14_2020-04-18.png)
...
[Download data as CSV](COVID-19_veneto_j14_2020-04-18.csv)
