...
|-------|-----|--------|------|---|---|
|exp|y = 4.0724 exp(-0.1031x)  [TAFE=0.0431]|0.0431|0.0015|14|n/a|

![Plot](COVID-19_veneto_j14_2020-04-16.png)
...
[Download data as CSV](COVID-19_veneto_j14_2020-04-16.csv)
