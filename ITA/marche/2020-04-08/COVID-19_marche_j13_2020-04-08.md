...
|-------|-----|--------|------|---|---|
|exp|y = 9.5196 exp(-0.1599x)  [TAFE=0.0536]|0.0536|0.0023|15|n/a|

![Plot](COVID-19_marche_j13_2020-04-08.png)
...
[Download data as CSV](COVID-19_marche_j13_2020-04-08.csv)
