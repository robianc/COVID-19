...
|-------|-----|--------|------|---|---|
|exp|y = 1.3996 exp(-0.0864x)  [TAFE=0.0359]|0.0359|0.0012|4|n/a|

![Plot](COVID-19_marche_j13_2020-04-19.png)

## Data
|Date|Daily deaths|Cumulated deaths|Deaths in the last 13 days|Deaths in the 13 days before|ratio|
|----|----------|-----------|-------|--------------------|-----|
|2020-04-19|12|807|195|381|0.5118|
...
[Download data as CSV](COVID-19_marche_j13_2020-04-19.csv)
