...
|-------|-----|--------|------|---|---|
|exp|y = 1.6852 exp(-0.1019x)  [TAFE=0.0496]|0.0496|0.0017|6|n/a|

![Plot](COVID-19_marche_j12_2020-04-16.png)
...
[Download data as CSV](COVID-19_marche_j12_2020-04-16.csv)
