...
|-------|-----|--------|------|---|---|
|exp|y = 0.8950 exp(-0.0711x)  [TAFE=0.0848]|0.0848|0.0048|2|n/a|
|pow|y = 0.9395 x pow(-0.2841)  [TAFE=0.0745]|0.0745|0.0030|2|n/a|

![Plot](COVID-19_marche_j9_2020-04-16.png)
...
[Download data as CSV](COVID-19_marche_j9_2020-04-16.csv)
