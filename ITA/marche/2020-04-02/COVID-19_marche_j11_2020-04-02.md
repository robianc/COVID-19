...
|-------|-----|--------|------|---|---|
|exp|y = 10.9613 exp(-0.1593x)  [TAFE=0.0619]|0.0619|0.0023|16|n/a|

![Plot](COVID-19_marche_j11_2020-04-02.png)
...
[Download data as CSV](COVID-19_marche_j11_2020-04-02.csv)
