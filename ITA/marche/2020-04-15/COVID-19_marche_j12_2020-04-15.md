...
|-------|-----|--------|------|---|---|
|linear|y = 1.8107 -0.1168x  [TAFE=0.1179]|0.1179|-0.0005|7|16|
|exp|y = 1.9905 exp(-0.1100x)  [TAFE=0.0618]|0.0618|0.0026|7|n/a|

![Plot](COVID-19_marche_j12_2020-04-15.png)
...
[Download data as CSV](COVID-19_marche_j12_2020-04-15.csv)
