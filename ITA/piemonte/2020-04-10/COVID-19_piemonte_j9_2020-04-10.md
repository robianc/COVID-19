...
|-------|-----|--------|------|---|---|
|linear|y = 2.1667 -0.1308x  [TAFE=0.0793]|0.0793|0.0082|9|17|
|exp|y = 2.2590 exp(-0.0861x)  [TAFE=0.0642]|0.0642|0.0040|10|n/a|

![Plot](COVID-19_piemonte_j9_2020-04-10.png)
...
[Download data as CSV](COVID-19_piemonte_j9_2020-04-10.csv)
