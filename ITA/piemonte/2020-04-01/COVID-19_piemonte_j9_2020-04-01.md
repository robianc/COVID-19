...
|-------|-----|--------|------|---|---|
|pow|y = 3.6813 x pow(-0.2135)  [TAFE=0.0466]|0.0466|0.0023|n/a|n/a|

![Plot](COVID-19_piemonte_j9_2020-04-01.png)
...
[Download data as CSV](COVID-19_piemonte_j9_2020-04-01.csv)
