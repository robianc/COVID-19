...
|-------|-----|--------|------|---|---|
|exp|y = 3.6469 exp(-0.0775x)  [TAFE=0.0645]|0.0645|0.0029|17|n/a|
|pow|y = 4.3397 x pow(-0.4197)  [TAFE=0.0567]|0.0567|0.0027|34|n/a|

![Plot](COVID-19_piemonte_j14_2020-04-17.png)
...
[Download data as CSV](COVID-19_piemonte_j14_2020-04-17.csv)
