...
|-------|-----|--------|------|---|---|
|exp|y = 3.4738 exp(-0.0795x)  [TAFE=0.0656]|0.0656|0.0031|16|n/a|
|pow|y = 4.0001 x pow(-0.4022)  [TAFE=0.0610]|0.0610|0.0034|32|n/a|

![Plot](COVID-19_piemonte_j13_2020-04-15.png)
...
[Download data as CSV](COVID-19_piemonte_j13_2020-04-15.csv)
